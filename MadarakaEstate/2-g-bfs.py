...
y.add_edge("SportsComplex", "Siwaka")
y.add_edge("Siwaka", "Ph.1A")
y.add_edge("Siwaka", "Ph.1B")
y.add_edge("Ph.1A", "Ph.1B")
y.add_edge("Ph.1A", "Mada")

y.add_edge("Ph.1B", "Phase2")
y.add_edge("Ph.1B", "STC")
y.add_edge("STC", "Phase2")

y.add_edge("Phase2", "Phase3")
y.add_edge("Phase2", "J1")
y.add_edge("Phase3", "ParkingLot")
y.add_edge("STC", "ParkingLot")
...
class Node:
    ...
    def __init__(self, name:str, parent:str):
        self.name = name
        self.parent = parent
        self.y = 0 # Distance to start node
    ...
    while len(open) > 0:
        ...
        if current_node == goal_node:
            ...
            while current_node != start_node:
                path.append(current_node.name + ': ' + str(current_node.y))
                current_node = current_node.parent
            path.append(start_node.name + ': ' + str(start_node.y))
        ...
        for key, value in neighbors.items():
            ...
            neighbor.y = current_node.y + graph.get(current_node.name, neighbor.name)
